...
function WheelColumn({
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="text-[10px] text-muted mb-1 uppercase tracking-wider">{label}</div>
      <div className="relative" style={{ height: itemHeight * visibleCount, width: 48 }}>
        {/* highlight strip */}
        <div
          className="absolute left-0 right-0 w-full bg-primary-500/10 rounded-lg pointer-events-none border border-primary-100"
          style={{
            top: itemHeight * 1,
            height: itemHeight,
          }}
        />
        {/* gradient fade */}
        <div className="absolute top-0 left-0 right-0 h-[32px] bg-gradient-to-b from-surface to-transparent pointer-events-none z-10" />
        <div className="absolute bottom-0 left-0 right-0 h-[32px] bg-gradient-to-t from-surface to-transparent pointer-events-none z-10" />
        {/* scrollable list */}
        <div
          ref={listRef}
          onScroll={onScroll}
