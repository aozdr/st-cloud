...
- taskId：TASK-20260919-team-search-watch-frontend
- 模型：GPT-5.6-Luna max；不得更换模型。
- State：.ai/state/20260919-team-search-watch.yaml；design revision：tsw-design-r1。
- 输入：.ai/docs/20260919-team-search-watch/{requirement,uispec,design,testcases}.md。
...
- .ai/docs/20260919-team-search-watch/frontend-changereport.md。
- .ai/runtime/results/DISPATCH-20260919-TSW-FE-A1.json。
...
独立结果 by=/root/luna_frontend_0919，criterion=IMPLEMENTED，revision=tsw-code-r1；真实测试证据与变更清单，禁止修改 State 或声称整体完成。
